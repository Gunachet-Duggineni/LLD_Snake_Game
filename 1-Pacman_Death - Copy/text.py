# This file manages all the text displayed in the game, like scores, level names, and "Game Over."
# text.py is used for:
#   Showing scores and other messages on the screen.
#   Displaying text in a style that matches the Pacman theme.
#   Handling any updates to text, like changing scores or displaying new messages.

# text.py is used in:
#   pacman.py: to display Pacman’s score and any life updates.
#   pauser.py: to show a "Paused" message when the game is paused.
#   run.py: to display general game messages, like "Game Over" or "You Win."

# In short: text.py makes sure players are informed with cool-looking text throughout the game!
