# This file handles all the visual elements of the Pacman game, like images and animations.
# sprites.py is used for:
#  Creating images for different game characters (like Pacman, Ghosts, and Pellets).
#  Making sure characters move with the right animations.
#  Drawing the game elements on the screen using the correct sizes and colors.

# sprites.py is used in 
# pacman.py: to show Pacman on the screen and control how it moves.
# ghosts.py: to show the ghosts and make them move.
# entity.py: to draw other game objects like pellets and portals.
# constants.py: to get information like colors and sizes for the visuals.

# In short: sprites.py makes sure everything looks fun and works visually in the game!
